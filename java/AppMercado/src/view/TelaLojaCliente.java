 ...
 * @author andre
 */
public class TelaLojaCliente extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLojaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void deletarProduto() {
        ...
        carrinho.removeProduto(p, quantidade);
//        TelaLogin.cliente.getCarrinho().removeProduto(p, quantidade);
    ...
    private void adicionarProduto() {
        ...
        boolean sucesso = carrinho.addLista(produto, quantidade);
    ...
    private void atualizarTabelaCarrinho() {
        ...
        for(ItensCarrinho item : carrinho.getItensCarrinhoList()){
            Object[] rowData = {
