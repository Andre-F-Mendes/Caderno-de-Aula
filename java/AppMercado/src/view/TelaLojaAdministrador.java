 ...
 * @author andre
 */
public class TelaLojaAdministrador extends javax.swing.JFrame {
     ...
     */
    public TelaLojaAdministrador() {
        initComponents();

        prdao = ProdutoDAO.getInstance();
        adao = AdministradorDAO.getInstance();
        adm = (Administrador) adao.read(AppMercado.cod);
        enderecoCheckBox();
    ...
    private void initComponents() {
        ...
        jMenuItem4.setText("Administrar administradores");
        jMenu2.add(jMenuItem4);

        jMenuItem5.setText("Administrar produtos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLojaAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void deletarProduto() {
        ...
        String str = (String) produtosComboBox.getSelectedItem();

        Produto p = prdao.fromMarcaNome(str);

        quantidade = (int) quantidadeSpn.getValue();
        adm.getCarrinho().removeProduto(p, quantidade);
//        TelaLogin.cliente.getCarrinho().removeProduto(p, quantidade);
    }

    private void adicionarProduto() {
        String strProduto = (String) produtosComboBox.getSelectedItem();
        Produto produto = prdao.fromMarcaNome(strProduto);
        ...
        boolean sucesso = adm.getCarrinho().addLista(produto, quantidade);
        //boolean sucesso = TelaLogin.cliente.getCarrinho().addLista(produto, quantidade);

        if (sucesso) {
            atualizarTabelaCarrinho();
        } else {
            JOptionPane.showMessageDialog(this, "Quantidade excedente", "Aviso", JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private void atualizarTabelaCarrinho() {
        ...
        for (ItensCarrinho item : adm.getCarrinho().getItensCarrinhoList()) {
            Object[] rowData = {
